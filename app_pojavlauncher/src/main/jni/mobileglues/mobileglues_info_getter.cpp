...
Java_net_kdt_pojavlaunch_mobileglues_MGInfoGetter_getMobileGluesGLInfo(JNIEnv *env,
                                                                          jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_net_kdt_pojavlaunch_mobileglues_MGBench_runMultidrawBench(JNIEnv *env, jobject thiz,
...
Java_net_kdt_pojavlaunch_mobileglues_MGBench_benchProgress(JNIEnv *env, jobject thiz) {
    (void)env;
    (void)thiz;
    std::lock_guard<std::mutex> lock(g_bench_progress_mutex);
...
extern "C"
JNIEXPORT jint JNICALL
Java_net_kdt_pojavlaunch_mobileglues_MGInfoGetter_setenv(JNIEnv *env, jobject thiz, jstring key,
